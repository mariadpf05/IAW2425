function validar(elementos){
    ...
    if (!validaPasswords()){ 
        document.getElementById("campo7").innerHTML = "El PIN no cumple con requisitos de longitud o no coinciden";        
        document.getElementById("campo8").innerHTML = "El PIN no cumple con requisitos de longitud o no coinciden";
        estanCorrectos = false;
    }
    if (!validarDNI()){
